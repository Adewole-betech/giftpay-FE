    ...
    <div className="flex flex-col items-center bg-[#101828] w-full">
      ...
      >
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-16 py-8 md:pt-12 lg:pt-16 md:pb-10 lg:pb-12">
          ...
          <div className="grid grid-cols-2 md:flex gap-4 md:flex-nowrap lg:gap-8 w-full md:justify-between">
        ...
        <div className="flex flex-col-reverse md:flex-row gap-3 md:justify-between items-center py-4 md:py-8 lg:py-12 w-full">
          ...
          <div className="flex items-center gap-3 md:gap-4 lg:gap-6">
            ...
            <Link href="https://linkedin.com" target="_blank">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_101_32924)">
            ...
            <Link href="https://facebook.com" target="_blank">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_101_32925)">
            ...
            <Link href="https://github.com" target="_blank">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clipPath="url(#clip0_101_32926)">
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
