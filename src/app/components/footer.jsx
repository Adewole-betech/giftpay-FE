      ...
      >
        <div className="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-16 py-8 md:pt-12 lg:pt-16 md:pb-10 lg:pb-12">
          <div className="flex flex-col w-1/2 gap-4 lg:gap-6 2xl:gap-8">
            ...
            <p className="text-lg lg:text-xl leading-[1rem] lg:leading-[2rem] text-[#eaecf0]">
              Design amazing digital experiences that create more happy in the
              world.
            </p>
          </div>
          <div className="flex gap-4 flex-wrap md:flex-nowrap lg:gap-8 w-full md:justify-between">
            <div className="flex flex-col gap-3 lg:gap-4">
              <p className="text-xs md:text-sm font-semibold text-[#98a1b2]">
                Company
              </p>
              <div className="flex flex-col gap-2 lg:gap-3 text-sm lg:text-base">
                <Link
                  href={"/about"}
                  className="text-[#eaecf0] hover:text-primary font-medium"
                >
                  About Us
                </Link>
                <Link
            ...
            <div className="flex flex-col gap-3 lg:gap-4">
              <p className="text-xs lg:text-sm font-semibold text-[#98a1b2]">
                Explore
              </p>
              <div className="flex flex-col gap-2 lg:gap-3 text-sm lg:text-base">
                <Link
        ...
        <div className="flex flex-col-reverse md:flex-row gap-3 md:justify-between md:items-center py-4 md:py-8 lg:py-12 w-full">
          <p className="text-sm md:text-base font-semibold text-[#98a1b2]">
            © 2024 Ugifty. All rights reserved.
          </p>
          <div className="flex items-center gap-3 md:gap-4 lg:gap-6">
            <Link href="https://x.com" target="_blank">
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="fill-[#98A2B3] hover:fill-primary"
            ...
            <Link href="https://linkedin.com" target="_blank">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
              >
                <g clip-path="url(#clip0_101_32924)">
