...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center h-screen overflow-y-auto overflow-x-clip relative w-full">
      <Header />
      <div className="flex flex-col w-full max-w-[1440px] bg-cover bg-no-repeat bg-[url('./assets/images/home/homepageBG.jpeg')] h-full -mt-20">
        <div className="flex flex-col items-center bg-black/50 w-full h-full">
          <div className="flex flex-col items-center w-full relative">
            <div className="flex flex-col justify-center h-[calc(100vh-6rem)] 2xl:h-[70vh] w-full px-8 md:px-12 lg:px-20 2xl:px-28">
      ...
      <div className="flex flex-col items-center w-full relative">
        <div className="flex flex-col items-center w-full max-w-[1440px] px-8 md:px-12 lg:px-20 2xl:px-28 h-64">
          <div className="flex flex-col gap-6 2xl:gap-8 bg-white rounded-lg shadow-xl relative -top-[35%] p-10 lg:p-12 2xl:p-16 w-full">
            <p className="text-xl lg:text-2xl 2xl:text-3xl font-semibold">
      ...
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col w-full max-w-[1440px] px-8 md:px-12 lg:px-20 2xl:px-28 py-8 md:py-12 lg:py-16 2xl:py-24 gap-6 lg:gap-12 2xl:gap-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 2xl:gap-16 items-center">
            ...
            <div className="h-[40rem] w-full bg-cover bg-center bg-no-repeat bg-[url('./assets/images/home/sellers.jpeg')] rounded-lg"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 2xl:gap-16 items-center">
            <div className="h-[40rem] w-full bg-cover bg-center bg-no-repeat bg-[url('./assets/images/home/buyers.jpeg')] rounded-lg"></div>
            <div className="flex flex-col items-start gap-4 lg:gap-8">
              <div className="flex items-center justify-center rounded-s-full rounded-e-full font-medium text-[#004EEB] bg-[#EFF4FF] py-2 lg:py-2.5 px-4 lg:px-5">
                For Buyers
              </div>
      ...
      <div className="flex flex-col items-center bg-[#F5F8FF] w-full">
        <div className="flex flex-col items-center w-full max-w-[1440px] px-8 md:px-12 lg:px-20 2xl:px-28 py-8 md:py-12 lg:py-16 2xl:py-24 gap-6 lg:gap-12 2xl:gap-16">
          <div className="flex flex-col items-center gap-4 lg:gap-6 2xl:gap-8">
            <div className="flex flex-col items-center text-center gap-3 lg:gap-4 2xl:gap-5">
              <p className="font-semibold text-2xl lg:text-3xl 2xl:text-4xl max-w-[80%]">
            ...
            <Segmented
              size="large"
              className="font-medium w-fit gap-2 border"
              options={[
                {
                  label: (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 w-full">
            <div className="bg-white flex items-center justify-center rounded-md w-full p-3 lg:p-4 h-[11.25rem]">
              <Image src={amazonLogo} width={150} />
            </div>
            <div className="bg-white flex items-center justify-center rounded-md w-full p-3 lg:p-4 h-[11.25rem]">
              <Image src={appleLogo} width={80} />
            </div>
            <div className="bg-white flex items-center justify-center rounded-md w-full p-3 lg:p-4 h-[11.25rem]">
              <Image src={ebayLogo} width={100} />
            </div>
            <div className="bg-white flex items-center justify-center rounded-md w-full p-3 lg:p-4 h-[11.25rem]">
              <Image src={walmartLogo} width={150} />
            </div>
            <div className="bg-white flex items-center justify-center rounded-md w-full p-3 lg:p-4 h-[11.25rem]">
              <Image src={amazonLogo} width={150} />
            </div>
      ...
      <div className="flex flex-col items-center w-full">
        <div className="flex flex-col w-full max-w-[1440px] px-8 md:px-12 lg:px-20 2xl:px-28 py-8 md:py-12 lg:py-16 2xl:py-24 gap-6 lg:gap-12 2xl:gap-16 relative">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 2xl:gap-24">
            ...
            <div className="flex flex-col gap-4 lg:gap-8 2xl:gap-12 lg:mt-2.5">
              <div className="flex flex-col gap-1.5 lg:gap-2">
                ...
                <p className="text-textBody text-sm lg:text-base leading-[1rem] lg:leading-[2rem]">
          ...
          <div className="bg-cover bg-center bg-no-repeat rounded-lg bg-[url('./assets/images/home/giftcard.jpeg')] h-[32rem]"></div>
          <div className="h-0 bg-transparent">
            <div className="flex flex-col lg:flex-row items-start gap-4 2xl:gap-6 bg-[#004eeb] text-white rounded-lg shadow-xl relative top-[35%] mb-11 p-10 lg:p-12 2xl:p-16 w-full">
              <div className="flex flex-col gap-3 lg:gap-4">
                <p className="font-semibold text-xl lg:text-2xl 2xl:text-3xl">
                  Find the Perfect Gift Card Deals!
                </p>
                <p className="text-lg lg:text-xl leading-[1rem] lg:leading-[2rem]">
