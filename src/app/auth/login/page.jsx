    ...
    <div className="flex flex-col w-full h-full justify-center items-center">
      <div className="flex flex-col gap-4 lg:gap-6 2xl:gap-8 px-4 xl:px-8 w-full lg:max-w-[80%] 2xl:max-w-[70%]">
        <div className="flex flex-col gap-2 lg:gap-3">
          <p className="font-semibold text-2xl lg:text-3xl">Sign in</p>
          <p className="text-sm sm:text-base text-textBody">Welcome Back!</p>
        </div>
        <Form
          layout="vertical"
          form={loginForm}
        ...
        >
          ...
          <div className="flex flex-col text-xs md:text-sm justify-between py-2 md:py-4">
            <Link
